...
fun main() {
    ...
    var car1 = Car("G-wagon ,2018", 26000000, "Fenil", 10000, 18500000)

    println("Created car2 named object of class Car")
    var car2 = Car("Ciaz ,2017", 1250000, "Vanvirbhai", 41000, 850000)

    println("Created car3 named object of class Car")
    var car3 = Car("Scorpio ,2010", 1700000, "Chaudhari", 40000, 100000)
}